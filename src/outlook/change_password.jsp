...
<body>
    ...
    <%out.print("<form class=\"form-signin\" method=\"post\" action=\"password_check.jsp\">");%>
    <div class="row">
        <div class="input-group">
            <span class="input-group-addon">原密码</span>
            <input type="text" class="form-control" aria-describedby="basic-addon3" name="origin_pwd" required>
        </div>
        <br/>
        <div class="input-group">
            <span class="input-group-addon">新密码</span>
            <input class="form-control" aria-describedby="basic-addon3" name="new_pwd_1" required type="password">
        </div>
        <br/>
        <div class="input-group">
            <span class="input-group-addon">再次输入新密码</span>
            <input class="form-control" aria-describedby="basic-addon3" name="new_pwd_2" required type="password">
        </div>
        <br/>

    </div>
    <div style="max-width:750px;margin-left:auto;margin-right:auto;" align="center">
       <button type="submit" class="btn btn-lg btn-primary" role="button">确认修改</a>
    </div>
    </form>
</body>
