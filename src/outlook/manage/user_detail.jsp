    ...
    <nav class="navbar navbar-default navbar-static-top">
      ...
      <!-- /.container-fluid -->
    	...
    	try{
    		...
    		if(!rs.next())out.print("无所要找的用户");
            else{
                String password=rs.getString(4);
            String phone=rs.getString(2);
    		out.print("<form class=\"form-signin\" method=\"post\" action=\"user_change_confirm.jsp?name="+username+"\">");
            out.print("<div class=\"row\">\r\n" + 
				"        <label for=\"basic-url\">修改用户信息</label>\r\n" +  
				...
				"            <input type=\"text\" class=\"form-control\" aria-describedby=\"basic-addon3\" name=\"password\" required value=\""+password+"\">\r\n" + 
				"        </div>\r\n" + 
				"        <br/>\r\n" + 
				"    </div>");
            }
        ...
        %>
            ...
            <button type="submit" class="btn btn-lg btn-primary" role="button">修改信息</button>
             <a class="btn btn-lg btn-default" role="button">删除用户</a>
            </div>
            <br/>
        </form>
</body>
