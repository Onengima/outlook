...
<body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="login_check.jsp">
        ...
        <input class="form-control" id="inputEmail" autofocus required type="email" placeholder="Email address" name="name">
        <label class="sr-only" for="inputPassword">Password</label>
        <input class="form-control" id="inputPassword" required type="password" placeholder="Password" name="pwd">
        <br/>
        <button class="btn btn-lg btn-primary btn-block" type="submit">登陆</button>
        <a class="btn btn-default btn-lg btn-block" role="button" href="registration.jsp">注册</a>
      </form>
