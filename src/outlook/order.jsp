...
<body>
    ...
    <%out.print("<form class=\"form-signin\" method=\"post\" action=\"order_confirm.jsp\">");%>
    <div class="row">
        <label for="basic-url">输入订单信息</label>
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" aria-describedby="basic-addon3" name="address" required>
        </div>
        <br/>
        <div class="input-group">
            <span class="input-group-addon">收货人手机号</span>
            <input type="text" class="form-control" aria-describedby="basic-addon3" name="phone" required>
        </div>
        <br/>

    </div>
    <div style="max-width:750px;margin-left:auto;margin-right:auto;" align="center">
       <%out.print("<button type=\"submit\" class=\"btn btn-lg btn-primary\" role=\"button\">确认付款"+total+"￥</a>");
